...
const Navbar = ({ logo }) => {
  const genreStyle =
    "bg-gray-950 text-gray-300 px-2 py-1 rounded-md m-1 cursor-pointer";
    ...
    >
      <nav className="flex justify-between items-center bg-black text-white p-2">
        <div className="flex items-center space-x-20">
          <div
            className="logo text-green-500 p-2 text-4xl font-bold font-stretch-expanded"
    ...
    >
      <h1 className="flex items-center gap-2">
        ...
        <a
          href={link}
          target="_blank"
          className="hover:bg-green-400/30 border-b-2 border-green-500 hover:text-white transition-colors p-1 rounded flex items-center gap-1"
        >
