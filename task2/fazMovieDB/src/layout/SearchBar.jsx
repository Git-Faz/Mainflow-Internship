      ...
      <div className="relative">
        ...
        >
          <input
            ...
            value={search}
            className="p-2 bg-transparent text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none w-48 md:w-80 transition-all duration-200"
            onChange={handleSearch}
          />
          {search ? (
            <button
              onClick={clearSearch}
              className="size-8 hover:text-red-500 text-gray-400 cursor-pointer transition-colors duration-200"
            >
              ✕
            </button>
          ) : (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400 capitalize">
                    {result.media_type === 'person' ? 'Person' : result.media_type}
                  </p>
                  {result.release_date && (
